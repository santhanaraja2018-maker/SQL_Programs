...
DECLARE
        ...
        LOOP
            ...
            DBMS_OUTPUT.PUT_LINE('BUS_OPERATOR : '||BUS_DTLS_RECORD.BUS_OPERATOR ||'SEATS : '||BUS_DTLS_RECORD.SEATS_AVAILABLE||'RATING : '||BUS_DTLS_RECORD.BUS_RATING ||' DEPARTURE_TIME : '||BUS_DTLS_RECORD.DEPARTURE_TIME);
        END LOOP;
        CLOSE RESULT;
END;
